    ...
    <v-form ref="formRef" @submit.prevent="save">
      ...
      <v-card class="rounded-xl pa-6 mb-6" elevation="0">
        ...
        <v-row>
          <v-col cols="12" md="6">
            <label
              class="text-subtitle-2 text-grey-darken-1 font-weight-medium mb-2 d-block"
              ><span>{{ t("firstname") }}</span></label
            >
            <v-text-field
      ...
      <v-card class="rounded-xl pa-6 mb-6" elevation="0">
        ...
        <v-row>
          ...
          <v-col cols="12" md="4">
            <label
              class="text-subtitle-2 text-grey-darken-1 font-weight-medium mb-2 d-block"
              ><span>{{ t("admissiondate") }}</span></label
            >
            <v-text-field
      ...
      <v-card class="rounded-xl pa-6" elevation="0">
        <div class="d-flex align-center mb-6">
          <v-avatar color="teal-lighten-5" size="48" class="mr-4 rounded-lg">
            <v-icon color="teal-darken-1" size="24"
        ...
        <v-row>
          ...
          <v-col cols="12">
            <label
              class="text-subtitle-2 text-grey-darken-1 font-weight-medium mb-2 d-block"
              >Emergency Guardian Contact</label
            >
            <v-text-field
